...
-- Alter table to add Total Revenue
ALTER TABLE Sales ADD COLUMN Totalrevenue NUMERIC;

-- Update the Total Revenue column
UPDATE Sales S
...
SELECT P.productname, SUM(S.totalrevenue) AS totalRevenue
FROM Sales S 
JOIN Products P ON S.productid = P.productid
...
-- Retrieve customers who have made purchases totaling more than $10,000 using subquery
